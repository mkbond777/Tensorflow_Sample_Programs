...
Y = tf.placeholder(tf.float32, shape=(), name='life_expetency')

# Step 3: create weight and bias, initialized to 0.0
# Make sure to use tf.get_variable
w = tf.get_variable("weight", shape=(), initializer=tf.zeros_initializer())
...
loss = tf.square(tf.subtract(Y, Y_predicted, name='subs'), name='loss')
